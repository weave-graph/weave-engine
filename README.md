...
See [current evidence and limitations](docs/STATUS.md), [implementation plan](docs/IMPLEMENTATION_PLAN.md), [workflow DAG](docs/WORKFLOW.md), [contract](docs/contract/v0.3/README.md) and [source provenance](docs/SOURCES.md). General joins, signed peer synchronization, capabilities/governance, real mobile/browser persistence, geometry and automatic clustering remain open. The original white papers remain to be reconciled. MIT licensed.
