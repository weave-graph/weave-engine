...
E05/E11 remain in progress. Required broader work includes portable accepted-decision transport, governed handler outputs/effect execution, remote authenticated subscriber operations, retention, and supported distributed consistency profiles.
