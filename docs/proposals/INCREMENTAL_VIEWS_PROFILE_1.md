...
Status: design for review, based on engine `45e0ea6`. No implementation, protocol change, storage marker or dependency installation is authorized by this document. E07 remains in progress.
